...
d-wrap: d-swig
	 $(CC) $(CFLAGS) -c -fpic delta.c delta_wrap.c -I/root/miniforge3/envs/py37/include/python3.7m
...
v-wrap: v-swig
	 $(CC) $(CFLAGS) -c -fpic libvankus.c libvankus_wrap.c -I/root/miniforge3/envs/py37/include/python3.7m
