...
d-wrap: d-swig
	 $(CC) $(CFLAGS) -c -fpic delta.c delta_wrap.c -I/root/miniforge3/envs/py311/include/python3.11
...
v-wrap: v-swig
	 $(CC) $(CFLAGS) -c -fpic libvankus.c libvankus_wrap.c -I/root/miniforge3/envs/py311/include/python3.11
